...
class MyRepo {
  ...
  static RxBool isSelectedMyStory=false.obs;
  ...
  static const List<String> dashboardIcon=[
    'assets/dashboard/animal.png',
    'assets/dashboard/fairy.png',
    'assets/dashboard/genie.png',
    'assets/dashboard/hero.png',
    'assets/dashboard/prince.png',
    'assets/dashboard/toy.png',
    'assets/dashboard/princes.png',
  ];
}
