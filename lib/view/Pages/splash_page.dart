            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children:  [
                    Text( MyRepo.storyTitle1.toString(), style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold, fontFamily: "BalooBhai", color: AppColors.kBtnColor),),
                    Text(MyRepo.storyTitle2.toString(), style: TextStyle(fontSize: 23, fontWeight: FontWeight.bold, fontFamily: "BalooBhai", color: AppColors.txtColor1),),
                    Text(MyRepo.storyTitle3.toString(), style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold, fontFamily: "BalooBhai", color: AppColors.txtColor1),),
                  ],
                ),
          ...
          Positioned(
            ...
            child: SizedBox(
              // height: MediaQuery.of(context).size.height/1.5,
                width: MediaQuery.of(context).size.width,
                child: Image.asset("assets/PNG/logo.png", scale: 1.5,)),
          ),
          ///Button
          Positioned(
            left: 40,
