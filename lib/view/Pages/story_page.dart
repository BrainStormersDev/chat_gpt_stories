...
import 'package:kids_stories/view/Pages/story_view_page.dart';
                        ...
                        child: DefaultTextStyle(
                          ...
                          child: Center(
                            child: AnimatedTextKit(
                              ...
                              repeatForever: true,
                              animatedTexts: [
                                TyperAnimatedText('${widget.data!.storyTitle}',
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          IconButton(
                                              onPressed:
                                              myCreatedStoryController.myCreatedStoryList.value.data!.indexWhere((element) =>
                                              element.storyTitle == widget.data!.storyTitle) == 0
                                                  ? null
                                                  : () {
                                                int newIndex =myCreatedStoryController
                                                    .myCreatedStoryList
                                                    .value
                                                    .data!
                                                    .indexWhere((element) =>
                                          ...
                                          GestureDetector(
                                            onTap: () async {
                                              ...
                                              await MyRepo.assetsAudioPlayer
                                                  .pause();
                                          ...
                                          IconButton(
                                              onPressed: (myCreatedStoryController
                                                  .myCreatedStoryList
                                                  .value
                                                  .data!
                                                  .lastIndexWhere(
                                                ...
                                                setState(() {
                                                  if (newIndex ==
                                                      myCreatedStoryController
                                                          ...
                                                          .data!
                                                          .length) {
                                                    widget.data = myCreatedStoryController
                                                        .myCreatedStoryList
                                                        .value
                                                        .data![newIndex];
                                                    // MyRepo.currentStory =
                                                    // controllerText.storyCategoryListModels
                                                    //     .value
                                                    //     .data![newIndex];
